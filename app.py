...
def pagina_sobre():
    ...
    st.markdown("IAnalisar os fatores institucionais e socioeconômicos associados ao número de matrículas (QT_MAT) nos cursos de graduação da RIDE-DF em 2023, considerando características dos cursos, perfis discentes e atributos das instituições de ensino.")
